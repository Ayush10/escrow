...
The original static dashboard exposed a dedicated verdict API. This shim keeps
that integration point in `console/`, but sources data from the authoritative
`apps/judge_service` backend.
"""
