...
The original static dashboard shipped a standalone watcher script. This
replacement keeps the entrypoint in `console/` but delegates to the canonical
judge service API, so the backend remains the source of truth.
"""
